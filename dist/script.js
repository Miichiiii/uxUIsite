...
var App = {
			init: function() {
						this.datetime(), this.side.nav(), this.search.bar(), this.navigation(), this.hyperlinks(), this.userRegistration(), setInterval(App.datetime, 1e3)
			},
			datetime: function() {
			...
			userRegistration: function() {
						$("#register-user").on("click", function() {
									...
									// Zeige die Registrierungsinformationen an
									$("#registration-result").html(`Registrierung erfolgreich!<br>${user.toString()}`);
 ...
 // TODO: Implementiere diese Klasse selbst
 class User {
    ...
    toString() {
        return `Name: ${this.name}, Alter: ${this.age}, Stadt: ${this.city}`;
    }
}
